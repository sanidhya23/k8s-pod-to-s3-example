...
cd .. <br />
export ECR_REPO=<aws account>.dkr.ecr.ap-south-1.amazonaws.com/ecr-test-repo1  <br />
...
eksctl create iamserviceaccount --name my-service-acc1 --namespace prod --cluster cluster1 --attach-policy-arn arn:aws:iam::<aws account>:policy/my-app-s3-policy <br />
eksctl create iamserviceaccount --name my-service-acc1 --namespace prod --cluster cluster1 --attach-policy-arn arn:aws:iam::<aws account>:policy/my-app-s3-policy --approve  <br />

eksctl create iamserviceaccount --name my-service-acc1 --namespace qa --cluster cluster1 --attach-policy-arn arn:aws:iam::<aws account>:policy/my-app-s3-policy <br />
eksctl create iamserviceaccount --name my-service-acc1 --namespace qa --cluster cluster1 --attach-policy-arn arn:aws:iam::<aws account>:policy/my-app-s3-policy --approve <br />
